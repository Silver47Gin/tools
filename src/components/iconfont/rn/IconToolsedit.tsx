...
let IconToolsedit: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconToolsedit.defaultProps = {
  size: 18,
};

IconToolsedit = React.memo ? React.memo(IconToolsedit) : IconToolsedit;

export default IconToolsedit;
