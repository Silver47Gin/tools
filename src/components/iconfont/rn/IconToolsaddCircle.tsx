...
let IconToolsaddCircle: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconToolsaddCircle.defaultProps = {
  size: 18,
};

IconToolsaddCircle = React.memo ? React.memo(IconToolsaddCircle) : IconToolsaddCircle;

export default IconToolsaddCircle;
