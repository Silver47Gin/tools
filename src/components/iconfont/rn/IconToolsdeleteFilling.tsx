...
let IconToolsdeleteFilling: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconToolsdeleteFilling.defaultProps = {
  size: 18,
};

IconToolsdeleteFilling = React.memo ? React.memo(IconToolsdeleteFilling) : IconToolsdeleteFilling;

export default IconToolsdeleteFilling;
